...
// Client ID of this "Ring-Ring" controller
const char* clientID = "node12";       //node ID

String topic1_topics        = "topics";
String topic2_ringring      = "ringring"; 
String topic3_heartbeatTime = "beattime";

String arrayRec [3] = {topic1_topics,topic2_ringring,topic3_heartbeatTime};
