...
LiquidCrystal_I2C lcd(0x27,2,1,0,4,5,6,7); // 0x27 is the default I2C bus address of the backpack-see article or 0x3F
//LiquidCrystal_I2C lcd(0x27, 16, 2); // 0x27 is the default I2C bus address of the backpack-see article or 0x3F
void setup()
{
   // Set off LCD module
